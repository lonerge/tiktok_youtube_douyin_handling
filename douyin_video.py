...
def get_douyin_origin_video(aweme_id):
    try:
        ...
        url_with_bogus = generate_request_params(url=f'https://www.douyin.com/aweme/v1/web/aweme/detail/?aweme_id={aweme_id}&aid=1128&version_name=23.5.0&device_platform=android&os_version=2333', user_agent=agent)["param"]
    except:
        logger.error(f'douyin aweme_id: {aweme_id} 获取 参数失败! error: {traceback.format_exc()}')
        return False
...
if __name__ == '__main__':
    ...
    print(get_douyin_origin_video(aweme_id='7344748942900333824'))
